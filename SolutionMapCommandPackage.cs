...
namespace SolutionMapper
{
    ...
    [Guid(SolutionMapCommandPackage.PackageGuidString)]
    ...
    public sealed class SolutionMapCommandPackage : AsyncPackage
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SolutionMapCommandPackage"/> class.
        /// </summary>
        public SolutionMapCommandPackage()
        {
